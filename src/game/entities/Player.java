...
public class Player extends Entity {
    ...
    public Player() {
        super(Resources.UP1, MathHelper.randomInt(2, 14), MathHelper.randomInt(2, 7));
        this.hp = 20;
        this.maxHp = 20;
        this.regenDelay = 0;
        this.armor = 0;
    ...
    public void move() {
        if(this.attackTime == 0) {
            super.move();
            switch(super.facing) {
                case NORTH: super.entityID = Resources.UP1; break;
                case SOUTH: super.entityID = Resources.DOWN1; break;
                case WEST: super.entityID = Resources.LEFT1; break;
                case EAST: super.entityID = Resources.RIGHT1; break;
            }
        }
    }
