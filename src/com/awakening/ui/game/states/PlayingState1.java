...
import com.awakening.ui.game.entities.Player1;
...
class PlayingState1 extends GameState {
    private LevelGenerator generator;
    private World world;
    private Player1 player;

    public PlayingState1(GameStateManager manager) {
        super(manager);
    ...
    private void playerAttacks() {
        ...
        for(int i=0;i<this.world.getRoom().getEnemies().size();i++) {
            this.world.getRoom().getEnemies().get(i).move1();
