...
import com.awakening.ui.game.entities.Player2;
...
class PlayingState2 extends GameState {

    private LevelGenerator generator;
    private World world;
    private Player2 player;

    public PlayingState2(GameStateManager manager) {
        super(manager);
    ...
    protected void loop() {
        ...
        this.world.getRoom().featureInteraction2(player);
    ...
    private void playerAttacks() {
        ...
        for(int i=0;i<this.world.getRoom().getEnemies().size();i++) {
            this.world.getRoom().getEnemies().get(i).move2();
