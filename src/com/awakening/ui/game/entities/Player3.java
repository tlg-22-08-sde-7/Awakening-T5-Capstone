...
public class Player3 extends Entity{
    ...
    public Player3() {
        super(Resources.PLAYER_3_STAND_DOWN, MathHelper.randomInt(2, 14), MathHelper.randomInt(2, 7));
        this.hp = 20;
        this.maxHp = 20;
    ...
    public void move() {
        if(this.attackTime == 0) {
            super.move();
            switch(super.facing) {
                case NORTH: super.id = Resources.PLAYER_3_STAND_UP; break;
                case SOUTH: super.id = Resources.PLAYER_3_STAND_DOWN; break;
                case WEST: super.id = Resources.PLAYER_3_STAND_LEFT; break;
                case EAST: super.id = Resources.PLAYER_3_STAND_RIGHT; break;
            }
        }
    }
